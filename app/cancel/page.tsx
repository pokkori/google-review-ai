export const metadata = {
  title: "解約・退会 | Google口コミ返信AI",
  description: "Google口コミ返信AIの解約・退会手続きページです。",
};
      ...
      <div className="max-w-md w-full bg-white/10 backdrop-blur-md rounded-2xl p-8 text-white">
        ...
        <div className="space-y-4 text-sm text-gray-300 mb-8">
          ...
          <div className="bg-white/5 rounded-lg p-4">
            ...
            <a
              href="mailto:support@levona.design?subject=%E8%A7%A3%E7%B4%84%E5%B8%8C%E6%9C%9B%EF%BC%9AGoogle%E5%8F%A3%E3%82%B3%E3%83%9F%E8%BF%94%E4%BF%A1AI"
