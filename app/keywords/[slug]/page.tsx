...
export const KEYWORDS: Record<string, KeywordData> = {
  "google-review-henshin-rei": {
    ...
    features: [
      { icon: "✍️", title: "返信文AI生成", text: "口コミ内容を入力するだけで状況に合った丁寧な返信文をAIが即時生成" },
      { icon: "🎭", title: "業種別テンプレート", text: "飲食店・美容院・病院など業種に合わせた返信テンプレートをAIが提供" },
      { icon: "⭐", title: "高評価・低評価対応", text: "5星・1星どちらの口コミにも適切なトーンで返信をAIが作成" },
    ],
    faqs: [
  ...
  "negative-review-taio-houhou": {
    ...
    features: [
      { icon: "🛡️", title: "悪評返信特化AI", text: "クレーム・低評価口コミに誠実かつ建設的に対応する返信文をAIが生成" },
      { icon: "🔍", title: "問題点分析", text: "口コミの内容から改善すべき点をAIが分析して返信に盛り込む" },
      { icon: "🤝", title: "関係修復サポート", text: "不満を持った顧客との関係修復につながる返信アプローチをAIが提案" },
    ],
    faqs: [
  ...
  "google-map-review-kanri": {
    ...
    features: [
      { icon: "📊", title: "口コミモニタリング", text: "新着口コミを管理して返信漏れを防ぐ管理体制づくりをAIがサポート" },
      { icon: "📈", title: "評価向上戦略", text: "Googleマップの評価を継続的に向上させるための戦略をAIが提案" },
      { icon: "🔄", title: "返信テンプレート管理", text: "業種・状況別の返信テンプレートをAIが作成して管理効率を向上" },
    ],
    faqs: [
  ...
  "restaurant-review-henshin": {
    ...
    features: [
      { icon: "🍽️", title: "飲食店特化テンプレート", text: "料理の感想・接客評価・衛生面など飲食店特有の口コミへの返信をAIが生成" },
      { icon: "👨‍🍳", title: "シェフ・オーナー目線の返信", text: "食へのこだわりや改善の姿勢が伝わる返信文をAIが作成" },
      { icon: "🔄", title: "リピート促進文句", text: "次回来店につながる一言をAIが自然に組み込んだ返信文を生成" },
    ],
    faqs: [
  ...
  "medical-review-taio": {
    ...
    features: [
      { icon: "🏥", title: "医療機関特化対応", text: "個人情報・診療情報の保護を最優先にした医療機関向け返信文をAIが生成" },
      { icon: "⚕️", title: "医療倫理に配慮した表現", text: "医師法・個人情報保護法に配慮した適切な表現でAIが返信文を作成" },
      { icon: "🤝", title: "患者信頼向上", text: "医療機関への信頼感を高める誠実な返信アプローチをAIが提案" },
    ],
    faqs: [
  ...
  "beauty-salon-review-reply": {
    ...
    features: [
      { icon: "💇", title: "美容院特化テンプレート", text: "ヘアカット・カラー・パーマなど施術別の口コミ返信をAIが生成" },
      { icon: "💅", title: "サロンブランドを守る返信", text: "サロンのブランドイメージを損なわない品のある返信文をAIが作成" },
      { icon: "🔄", title: "指名・再来店促進", text: "担当スタイリストへの指名や再来店につながる返信文をAIが生成" },
    ],
    faqs: [
  ...
  "google-review-sakujo-houhou": {
    ...
    features: [
      { icon: "🗑️", title: "削除申請サポート", text: "Googleのポリシー違反に該当する口コミの削除申請手順をAIが案内" },
      { icon: "📋", title: "申請文書作成", text: "削除申請に必要な説明文書をAIが作成。違反理由を明確に伝える文章を生成" },
      { icon: "🔄", title: "削除不可時の対応", text: "削除が認められない場合の適切な返信対応をAIが提案" },
    ],
    faqs: [
  ...
  "low-rating-recover-strategy": {
    ...
    features: [
      { icon: "📈", title: "評価回復プラン", text: "低評価からの回復に向けた体系的な口コミ管理プランをAIが設計" },
      { icon: "🎯", title: "高評価誘導策", text: "満足顧客から自然に高評価口コミを集める方法をAIが提案" },
      { icon: "🔄", title: "ネガティブループ脱出", text: "低評価が続く場合のパターン分析と根本原因の改善をAIがサポート" },
    ],
    faqs: [
  ...
  "review-management-best-practice": {
    ...
    features: [
      { icon: "📋", title: "口コミ管理マニュアル", text: "スタッフが迷わない口コミ対応マニュアルをAIが業種別に作成" },
      { icon: "🔔", title: "モニタリング体制構築", text: "新着口コミを見逃さないためのアラート設定と担当者体制の整備をAIが支援" },
      { icon: "📊", title: "KPI設定と改善サイクル", text: "口コミ評価に関するKPIと定期改善サイクルの仕組みをAIが設計" },
    ],
    faqs: [
  ...
  "google-business-hyoka-ageru": {
    ...
    features: [
      ...
      { icon: "📝", title: "プロフィール最適化", text: "Googleビジネスプロフィールの情報充実でローカルSEO効果を高める方法をAIが提案" },
      { icon: "🔄", title: "口コミ収集自動化", text: "自然な形で高評価口コミを継続的に集める仕組みをAIが設計" },
    ],
    faqs: [
